...
#get the last letter index of a string
print(result[-1])
print(result.find('string'))
print(result[15:-1])

#prints -1; means that it doesn't exist
print(result.find('hancock')) 

# index slicing is when you get a substring from a string
#you can get a substring by specifying the start and end index of substring.
...
##################################### String Methods#################################
new_text = "this is a new text text text string"
print(new_text.count("text"))
# .count meyhod counts the number of times a substring appears

#startswith() method check if a string starts with a specific substring
print(new_text.startswith("string"))

#startswith() method check if a string ends with a specific substring
print(new_text.endswith("string"))

#.replace() methiod replaces a substroing with another substring
